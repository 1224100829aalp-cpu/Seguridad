...
import mx.edu.utng.aalp.security01.models.User
 ...
 *
 * EXPLICACIÓN PARA ESTUDIANTES: * Esta clase simula un servidor real sin necesidad de tener uno activo. * Es como practicar fútbol con conos en lugar de jugadores reales. *
 * USO: Mientras desarrollan, pueden usar esto en lugar de la API real. * Cuando tengan servidor listo, solo cambian a RetrofitClient.
 */
